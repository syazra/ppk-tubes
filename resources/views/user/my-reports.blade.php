<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm rounded-xl p-6 sm:p-8 border border-gray-100">
                
                <div class="flex justify-between items-center mb-6 border-b pb-4">
                    <div>
                        <h3 class="text-xl font-bold text-gray-800">Daftar Pengaduan Kerusakan</h3>
                        <p class="text-sm text-gray-500 mt-1">Pantau status laporan kerusakan fasilitas yang telah kamu kirimkan.</p>
                    </div>
                ...
                {{-- 1. TAMBAHKAN ALERT / PESAN NOTIFIKASI DI SINI --}}
                @if(session('success'))
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Aksi</th> <!-- Kolom Aksi Tambahan -->
                            </tr>
                        </thead>
                        <tbody class="bg-white divide-y divide-gray-200 text-sm">
                            @forelse($reports as $index => $report)
                                <tr>
                                    ...
                                    {{-- 2. TOMBOL BATALKAN (Hanya muncul jika status masih pending) --}}
